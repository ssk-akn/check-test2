...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        $kiwiId = DB::table('products')->insertGetId([
            ...
            'description' => 'キウイは甘みと酸味のバランスが絶妙なフルーツです。ビタミンＣなどの栄養素も豊富なため、美肌効果や疲労回復効果も期待できます。もぎたてフルーツのスムージーをお召し上がりください！',
        ]);
        DB::table('product_season')->insert([
            ['product_id' => $kiwiId, 'season_id' => 3],
            ['product_id' => $kiwiId, 'season_id' => 4],
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $strawberryId, 'season_id' => 1],
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $orangeId, 'season_id' => 4],
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $watermelonId, 'season_id' => 2],
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $peachId, 'season_id' => 2],
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $muscatId, 'season_id' => 2],
            ['product_id' => $muscatId, 'season_id' => 3],
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $pineappleId, 'season_id' => 1],
            ['product_id' => $pineappleId, 'season_id' => 2],
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $grapesId, 'season_id' => 2],
            ['product_id' => $grapesId, 'season_id' => 3],
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $bananaId, 'season_id' => 2],
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $melonId, 'season_id' => 1],
            ['product_id' => $melonId, 'season_id' => 2],
        ]);
    }
}
